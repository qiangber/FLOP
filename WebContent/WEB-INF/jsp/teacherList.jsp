			...
			<div class="nTab">
				<div class="TabTitle">
					<ul id="myTab1">
						...
						<li id="li2" class="normal" onclick="window.location.href='preSave.do?type=teacher'">用户添加</li>
					</ul>
				</div>
				<div class="statics">
							...
							<table id="newsTable">
								...
								<tr>
									...
									<td style="width:100px;">
										<div id="edit"><a href="preSave.do?id=${user.id}&type=teacher"></a></div>
										<div id="delete"><a href="delete.do?id=${user.id}&type=teacher" onclick="return isDelete();"></a></div>
									</td>
								</tr>			
								</c:forEach>
							</table>
							<div class="pageCommon" style="cursor:hand">
								<div class="scottPage">
								    <c:if test="${currentPage != 1}">
								    	<span style="cursor:pointer"><a href="list.do?type=teacher&page=${1}">首页 </a></span>
						            	<a href="list.do?type=teacher&page=${currentPage-1}">上一页 </a>
						            </c:if>
								    <span class="currentPage" >${currentPage}/${pageCount}</span>
						            <c:if test="${currentPage != pageCount}">
						            	<a href="list.do?type=teacher&page=${currentPage+1}">下一页 </a>
									    <span style="cursor:pointer"><a href="list.do?type=teacher&page=${pageCount}">尾页 </a></span>
						            </c:if>
								</div>
							</div>
						</div>
