	...
	<div id="wrap">
		...
		<div id="right">
			...
			<div class="nTab">
				<div class="TabTitle">
					<ul id="myTab1">
						<li id="li1" class="active">类型列表</li>
						<li id="li2" class="normal" onclick="window.location.href='preSave.do'">类型添加</li>
					</ul>
				</div>
				<div class="statics">
						...
						<div id="newsList">
							<table id="newsTable">
								...
								<tr>
									...
									<td>
									<c:choose>
									<c:when test="${category.type == 'writing'}">写作预约</c:when>
									<c:when test="${category.type == 'speaking'}">口语预约</c:when>
									<c:when test="${category.type == 'lab'}">实验室预约</c:when>
									</c:choose>
									</td>
									<td style="width:100px;">
										<div id="edit"><a href="preSave.do?id=${category.id}"></a></div>
										<div id="delete"><a href="delete.do?id=${category.id}" onclick="return isDelete();"></a></div>
									</td>
								</tr>			
								</c:forEach>
							</table>
