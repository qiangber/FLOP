	...
	<div id="wrap">
		...
		<div id="right">
			...
			<div class="nTab">
				<div class="TabTitle">
					<ul id="myTab1">
						<li id="li1" class="normal" onclick="window.location.href='list.do'">相关介绍列表</li>
						<li id="li2" class="active">相关介绍修改</li>
					</ul>
				</div>
				<div class="statics">
					<div class="phone_pic" id="newsList0">
						<form action="save.do" method="post" name="newsForm" id="newsForm">
							<div class="newsTitle">
								<div class="underLine">
									<span style="font-size: 15px;">相关介绍类型</span>
								</div>
								...
								<input type="hidden" name="type" value="${about.type}">
							</div>							
