...
<script type="text/javascript" src="/FLOP/resources/js/options.js"></script>
</head>
			...
			<div class="nTab">
				<div class="TabTitle">
					<ul id="myTab1">
						...
						<li id="li3" class="active">类别上限</li>
					</ul>
				</div>
				<div class="statics">
					<div class="phone_pic" id="newsList0">
						<form action="updateLimit.do" method="post" name="newsForm" id="newsForm">	
							<div class="newsContent">
								<div class="underLine">
									<span style="font-size: 15px;">类别</span>
								</div>										
								<div class="leftInput">
								...
								<div class="leftInput">
									<input type="text" name="num" id="limit" style="width:200px;"/>
								</div>
							</div>
							</div>
